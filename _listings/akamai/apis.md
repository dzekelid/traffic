...
- name: Akamai API Get Event&#8217;s Origin Requests per CP Code
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/traffic/master/_listings/akamai/events-v2-accountid-events-eventid-trafficdata-cpcode-origin-requests-cpcode-get.md
x-common:
- type: x-base
