...
- name: Akamai API Get Aggregate Data for Silverlight Live Streams
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/traffic/master/_listings/akamai/events-v2-accountid-events-eventid-trafficdata-hdsll-egressbw-get.md
x-common:
- type: x-base
