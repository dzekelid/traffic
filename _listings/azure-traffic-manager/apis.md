...
- name: Azure Traffic Manager API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/traffic/master/_listings/azure-traffic-manager/providers-microsoft-network-trafficmanagergeographichierarchies-default-get.md
x-common:
